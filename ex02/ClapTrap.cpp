...
/*   Updated: 2024/01/13 11:09:51 by yamajid          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap():name("ClapTrap"), HitPoints(100), EnergyPoints(100), attackDamage(30){
...
void ClapTrap::beRepaired(unsigned int amount){
    if ((HitPoints > 0 && HitPoints < 100) && (EnergyPoints > 0 && EnergyPoints < 100)){
        HitPoints += amount;
        EnergyPoints--;
        std::cout << name << "Repairing and get " << amount << " point, the Energy points now is : " << EnergyPoints << std::endl;
    }
}
ClapTrap::ClapTrap(std:: string nm): name(nm), HitPoints(100), EnergyPoints(100), attackDamage(30){
